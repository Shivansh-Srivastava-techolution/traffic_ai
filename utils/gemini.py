                ...
                try:
                    response = client.models.generate_content(
                        ...
                        contents=[
                            ...
                            Make sure not to give false alarms.
                            Do not say jam if the number of vehicles is less than 10
                            Jam is only when a lot of vehcles are moving very slowly, this is ideally a slow moving traffic.
                            Just return a brief warning or say 'No incident'."""
                        ]
                    )
